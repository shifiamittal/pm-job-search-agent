...
def migrate_job(old, annotation, now):
    ...
    return {
        ...
        "technology_product_focus": old.get("technology_product_focus", annotation["technology"]),
        "key_gaps_risks": old.get("key_gaps_risks", annotation["gap_detail"]),
        "my_decision": old.get("my_decision", ""), "my_notes": old.get("my_notes", ""),
        "stage": "Closed" if status == "Closed" else old.get("stage", "Discovered"),
